...
Started: 2026-09-15
Current stage: 1 — Design (awaiting approval)
...
| 3 | Build | in progress | Common + API done ahead of design; dashboard form keeps new fields on save but has no inputs yet (waits for design approval) |
| 4 | Test | pending | |
